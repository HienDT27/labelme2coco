...
#dst_dir = 'cup_dataset'
src_dir = '/home/hien/3d/Dataset_Synthesizer/Source/NVCapturedData/TestCapturer_val/D1101/old_model3d'
dst_dir = '/home/hien/Desktop/annotation_utils-master/test/ndds2coco/crescent_dataset_val/D1101/old_model3d'
...
dataset.save_to_path(f'{dst_dir}/json_annotation_val.json', overwrite=True)
